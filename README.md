...
## Note: The package have been moved from `react-native-slide-charts` to [`@connectedcars/react-native-slide-charts`](https://www.npmjs.com/package/@connectedcars/react-native-slide-charts)
